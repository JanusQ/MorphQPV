...
class GroundStateEstimation:
    def __init__(self) -> None:
        pass
    def gen_circuit(self,choice: str) -> QuantumCircuit:
        ...
        """
        molecule = self.get_molecule(choice)
    ...
    def get_molecule(self,benchmark_instance_name: str) -> list[str]:
