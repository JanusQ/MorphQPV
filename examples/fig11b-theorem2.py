...
def plot_results():
    ...
    # ax.bar3d(X.ravel(), Y.ravel(), np.zeros_like(z.T).ravel(), 1, 1, z.T.ravel(), shade=True, cmap=cmap, alpha=1,linewidth=0.5)
    ## colorbar
        # ax.scatter(x, y, z, marker='o',c= z, cmap='Blues',s=50)
    diff=0
